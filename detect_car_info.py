...
Usage:
    ...
    python /home/pi/yolov5/detect_car.py --weights /home/pi/yolov5/emblem5.pt --max-det 1 --nosave --conf-thres 0.08 --imgsz 256 --source 'rtsp://192.168.10.150:554/11'
"""
import os
...
def run(weights=ROOT / 'emblem4.pt',  # model.pt path(s)
    ...
    start = time.time()
    drive_line_start, drive_line_stop = (0, 120), (932, 115)
    def line(x):
    ...
    def drive_sign(forward, side_offset):
        '''
        hvis samme lys har lyst i mer enn 30 sek, skal det skrus av!
        '''
        if forward <= 0:
            light_out("stop")
        elif side_offset > 15:
